...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | default | 192.168.0.35/24 | - |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | Uplink to SF_SITE_102_TOR-1B | routed | - | 10.255.102.7/31 | default | - | - | - | - |
...
| --------- | ----------- | --- | ---------- |
| Loopback10 | Inband management | default | 192.168.101.35/32 |
...
!
router bgp 65524
   router-id 10.255.102.7
   neighbor 10.255.102.6 peer group CE-PEER-GROUP
   neighbor 10.255.102.6 remote-as 6.6971
   !
   address-family ipv4

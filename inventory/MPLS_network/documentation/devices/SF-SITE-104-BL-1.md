...
| --------- | ----------- | --- | ---------- |
| Loopback0 | MPLS_Overlay_peering | default | 100.4.2.27/32 |
...
interface Loopback0
   ...
   no shutdown
   ip address 100.4.2.27/32
   isis enable CORE
   isis passive
   node-segment ipv4 index 27
!
...
| -------- | ----- |
| Instance | CORE |
| Net-ID | 51.0001.1921.6800.0027.00 |
| Type | level-2 |
